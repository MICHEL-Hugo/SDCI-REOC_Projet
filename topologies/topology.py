...
def create_topology():
    ...
    gi = net.addDocker('gi', ip='10.0.0.40/24',  mac='01:00:00:00:00:00', dimage='host:gateway', dcmd="node gateway.js --local_ip '10.0.0.40' --local_port 8281 --local_name 'gi' --remote_ip '10.0.0.50' --remote_port 8080 --remote_name 'srv'")
